...
describe('A MathBasic', () => {
  it('should contains add, subtract, multiply, and divide fuction', () => {
  ...
  describe('A add function', () => {
    it('should thwor error when not given 2 parameters', () => {
  ...
  describe('A divide function', () => {
    ...
    it('should return a / b when given with two number parameters', () => {
      ...
      expect(MathBasic.divide(10, 0)).toEqual(Infinity);
      expect(MathBasic.divide(0, 15)).toEqual(0);
    });
  });
});
